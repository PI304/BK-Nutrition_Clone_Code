				...
				<IntroContainer>
					...
					<ContentContainer>
						<GreetingBox>
							...
							<div>
								<p>
									<Strong>Brain Korea 21 FOUR 웰니스 융합인재 양성팀</Strong>은 국내외적으로 연구
									활동 및 교육 활동이 활발한 교수들로 구성되어 있습니다.
								</p>
								<p>
									Brain Korea 21 FOUR 웰니스 융합인재 양성팀은 학문 후속세대에게{' '}
									<Strong>국제적 수준의 교육/연구를 제공</Strong>하여,{' '}
									<Strong>사회 문제 해결과 미래 웰니스 식품영양기술의 신산업화</Strong>를 통해
									건강한 사회 구현에 기여하고 <Strong>글로벌 임팩트를 발휘하는 대학원</Strong>으로
									발돋움함과 동시에 <Strong>미래지향적인 융합혁신인재 양성과 배출의 요람</Strong>
									으로서 그 역할을 다하고자 합니다.
								</p>
								<p>
									...
									<Strong>
										활용 가능한 미래 식품영양 지식과 기술을 통한 국민건강 및 인류복지 실현에 함께
										공헌
									</Strong>
									할 수 있기를 바랍니다.
								</p>
								...
								<div>
									<div>
										...
										<p>
											...
											가능한 식품영양 기술개발을 통한 건강한 사회 구현에 기여하는, 혁신적 글로벌
											중심 대학원으로서 입지를 확고히 하는 것이다.
										</p>
									</div>
									<div>
